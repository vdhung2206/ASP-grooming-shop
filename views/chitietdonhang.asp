...
<!-- #include file="../share/header.html" -->
    <div class="container">
        ...
        <div class="form-group row mt-3" style="padding-left: 0; margin-left:0">
            ...
            <div class="col-lg-2">
                <button id="hanhdong" class="btn btn-primary mb-2"></button>
            </div>
            <div class="col-lg-2">
                <button  id="huydon" class="btn btn-danger mb-2">Hủy đơn</button>
            </div>
